...
# Monitoring module
# -----------------------------------------------------------------------------
# Creates the operational alarms and dashboard for the default platform session.
# Alerts focus on pipeline failure, Analytics Agent health, Application Load
# Balancer errors, latency, and Silver data freshness.
...
# -----------------------------------------------------------------------------
# 4. Analytics Agent load balancer alarms
# -----------------------------------------------------------------------------
...
# 1% of requests are already past one full Claude call cycle, so something
# is slow or stalling.
...
# -----------------------------------------------------------------------------
# 5. Silver data freshness alarms
# -----------------------------------------------------------------------------
...
# (no metric point exists) the alarm stays in OK. It is not an error to not have
